    ...
    <div className="   h-full w-[46%] border-r border-[#607B96] ">
        <div className="flex flex-col gap-16 p-96 justify-start items-start h-full w-[100%] text-[#607B96]">
            <div className="flex flex-col gap-4">
                ...
                <input type="text" className="w-[29rem] h-12 rounded-md bg-[#011221] border-[#1E2D3D] border focus:border-[#607B96] outline-none"/>
            </div>
            <div className="flex flex-col gap-4">
        ...
        <textarea  placeholder="" className="w-[29rem] h-[13rem] rounded-md bg-[#011221] border-[#1E2D3D] border focus:border-[#607B96] resize-none outline-none " />
            </div>
